...
main <- function (includeTable=FALSE) {
    ...
    if (DEV == 'web') {
        ...
        save (loaded_variables, file="/homes/pagapow/SmartR/Qq/loaded_variables.Rda")
        save (fetch_params, file="/homes/pagapow/SmartR/Qq/fetch_params.Rda")
    }
    if (DEV == 'r') {
    ...
    if (DEV != FALSE) {
        print ("In development for qq/run.R")
